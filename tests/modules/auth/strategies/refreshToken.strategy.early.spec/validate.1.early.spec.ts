...
describe('RefreshTokenStrategy.validate() validate method', () => {
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle Authorization header without Bearer prefix', () => {
      // Arrange: Set up a mock request with an Authorization header missing the Bearer prefix
      const mockRequest = {
        get: jest.fn().mockReturnValue('validRefreshToken'),
      } as unknown as Request;
      const mockPayload = { userId: 1, username: 'testUser' };
    ...
    it('should handle Authorization header with extra spaces', () => {
      // Arrange: Set up a mock request with an Authorization header containing extra spaces
      const mockRequest = {
        get: jest.fn().mockReturnValue('Bearer    validRefreshToken   '),
      } as unknown as Request;
      const mockPayload = { userId: 1, username: 'testUser' };
