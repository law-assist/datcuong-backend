...
const phanRegex =
  /^Phần thứ (\d|(mười một)|(mười hai)|(mười ba)|(mười bốn)|(mười lăm)|(mười sáu)|(mười bảy)|(mười tám)|(mười chín)|(hai mươi)|nhất|hai|ba|bốn|năm|sáu|bảy|tám|chín|mười)/i;
...
const dieuRegex = /(^Điều (\d+)(\.| :|:))|(^X{0,3}(IX|IV|V?I{0,3})(\.| \.))/;
